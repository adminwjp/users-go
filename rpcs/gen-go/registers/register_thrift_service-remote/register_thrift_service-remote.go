...
import (
	...
	"github.com/adminwjp/users-go/rpcs/gen-go/registers"
)

var _ = registers.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  ServiceReplyThrift Register(ServiceThrift input)")
  fmt.Fprintln(os.Stderr, "  ServiceReplyThrift Callback()")
  fmt.Fprintln(os.Stderr, "  ServiceApiThrift Check(NameThrift input)")
  fmt.Fprintln(os.Stderr, "  ServiceApiThrift Get(NameThrift input)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := registers.NewRegisterThriftServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "Register":
    ...
    argvalue0 := registers.NewServiceThrift()
  ...
  case "Callback":
    if flag.NArg() - 1 != 0 {
      fmt.Fprintln(os.Stderr, "Callback requires 0 args")
      flag.Usage()
    }
    fmt.Print(client.Callback(context.Background()))
    fmt.Print("\n")
    break
  case "Check":
    if flag.NArg() - 1 != 1 {
    ...
    argvalue0 := registers.NewNameThrift()
