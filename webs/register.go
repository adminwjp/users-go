...
func (ctrl *BaseUserCtrl) Register(httpWeb webs.HttpWeb){
...
func (ctrl *BaseUserCtrl) RegisterByEmail(httpWeb webs.HttpWeb,validate func(input *dtos.UserEmailInput)bool){
...
func (ctrl *BaseUserCtrl) RegisterByUserName(httpWeb webs.HttpWeb,validate func(input *dtos.UserUserNameInput)bool){
...
func (ctrl *BaseUserCtrl) RegisterByPhone(httpWeb webs.HttpWeb,validate func(input *dtos.UserPhoneInput)bool){
